...
<body>
	...
	<div class="row">
		<div class="col-md-3 col-md-3 col-sm-12">
			...
			<div class="row">
				<div class="menuBIS">
			 		<a href="mesInfos.html">Mes informations</a>
					<a href="modesPaiement.html">Mes modes de paiement</a>
		...
		<div class="col-md-7 col-md-7 col-sm-12">
			...
			<div class="row">
				<div class="col-md-2 col-md-2 col-sm-4">
					<img align="center" src="images/piece.jpg" height="70" width="70">
				</div>
                
                <div class="col-md-8 col-md-8 col-sm-8">
                	<p style="font-size: 18px; font-weight: bold;"> Monnaie grecque antique</p>
                	<p style="font-size: 14px; font-weight: bold;"> 45928548<br> 250€<br> Livraison prévue le 12/05/2020<br><a href="#"> Contacter le vendeur</a></p>
                </div>
			</div>
			...
			<div class="row">
				<div class="col-md-2 col-md-2 col-sm-4">
					<img align="center" src="images/montre.jpg" height="70" width="70">
				</div>
                
                <div class="col-md-8 col-md-8 col-sm-8">
                	<p style="font-size: 18px; font-weight: bold;"> KS Montre de poche</p>
                	<p style="font-size: 14px; font-weight: bold;"> 45928547<br> 150,00€<br> Livré le 11/04/2020<br><a href="#"> Contacter le vendeur</a></p>
                </div>
